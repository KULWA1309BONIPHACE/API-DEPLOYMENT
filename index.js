...
app.get("/students", async (req, res) => {
  try {
    // Static JSON data
    const students = [
      { name: "Kulwa Boniphace", program: "Software Engineering" },
      { name: "Bruno Fernandez", program: "Software Engineering" },
      { name: "Mrisho Ngassa", program: "Computer Science" },
      { name: "Adam Minja", program: "Software Engineering" },
      ...
      { name: "Ally Hassani", program: "Cybersecurity" },
